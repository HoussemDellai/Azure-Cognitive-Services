...
namespace ComputerVisionApplication.Services
{
    public class TextAnalyticsService
    {
        ...
        /// </summary>
        private string _detectLanguageUrl = "https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/languages";
        
        /// <summary>
        /// Doc:
        /// https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c6
        /// </summary>
        private string _detectKeyPhrasesUrl = "https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/keyPhrases";

        /// <summary>
        /// Doc: 
        /// https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c9/
        /// </summary>
        private string _detectSentimentUrl = "https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment";
