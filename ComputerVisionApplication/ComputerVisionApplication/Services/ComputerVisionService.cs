...
namespace CognitiveServices.Services
{
    ...
    public class ComputerVisionService
    {
        ...
        /// </summary>
        private readonly string _key = "c01672e9d941498f922d614cc08e3e78";// = "d5fdc78fad5b4cf98fce5df15146426d";

        /// <summary>
        /// Documentation for the API: https://www.microsoft.com/cognitive-services/en-us/computer-vision-api
        /// </summary>
        private readonly string _analyseImageUri = "https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze?" + "visualFeatures=Description,Categories,Tags,Faces,ImageType,Color,Adult&details=Celebrities";

        private readonly string _extractTextUri = "https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/ocr?" + "language=unk&detectOrientation=true";
